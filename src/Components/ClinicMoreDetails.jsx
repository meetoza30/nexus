        ...
        <div>
            <div className="secheader">
                ...
                <SectionHeader
                    ...
                    isSelected={selectedSection === 'Doctors'}
                />
                <SectionHeader
                    title="Services"
                    onClick={() => handleSectionClick('Services')}
                    isSelected={selectedSection === 'Services'}
                />
                <SectionHeader
                    title="Photos"
            ...
            <div className={`secontent ${selectedSection.toLowerCase()}-content`}>
                {selectedSection === 'Overview' && (
                    <div className="outercontain">
                        ...
                        <div id='service'>
                            Services:
                            <ul>
                                {currentClinic.services.slice(0, 5).map((it) => <li key={it}>{it}</li>)}
                            </ul>
                        </div>
                    </div>
                )}
...
function SectionHeader({ title, onClick, isSelected }) {
    return (
        <div
